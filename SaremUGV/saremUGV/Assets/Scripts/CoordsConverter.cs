...
public class CoordsConverter : MonoBehaviour
{
    public Vector2 originXZ = new Vector2(0f, 0f); // Origin point in XZ coordinates
    public Vector2 originLonLat = new Vector2(25.0513380f, 55.3779827f); // Corresponding origin point in LonLat

    // Earth's approximate radius in meters
    private const float EarthRadius = 6371000f;

    public Vector2 ConvertXZToLonLat(Vector2 xzCoordinates)
    {
    ...
    public Vector2 ConvertLonLatToXZ(Vector2 lonLatCoordinates)
    {
